...
Сначала проверь изменение в Telegram. Затем открой **Terminal → Run Task… / Терминал → Выполнить задачу…**, выбери **Magic Pet: проверить задание** и введи код из карточки, например `S1`.
